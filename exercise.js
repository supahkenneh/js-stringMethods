...
var longestPhrase = longestPlaceName + " is the longest place name in the world and has " + howManyLetters + " letters in its name.";
...
console.log("problem 2", fifthLetter);
